...
export const SLP_CATALOGUE = [
  ...
  // BDEW25 (2025 revision) — demandlib exposes these as separate classes
  // (H25/G25/L25). Household (h25) is the dynamic profile.
  { code: 'h25',    label: 'Household 2025 (h25, dynamic)',   group: 'BDEW25 (2025)' },
  { code: 'g25',    label: 'Commercial 2025 (g25)',           group: 'BDEW25 (2025)' },
  { code: 'l25',    label: 'Agriculture 2025 (l25)',          group: 'BDEW25 (2025)' },
];

// BDEW25 sector codes are generated by a different demandlib API (H25/G25/L25
// classes) than the classic SLPs (ElecSlp). The one-shot dispatches on family.
export const BDEW25_CODES = ['h25', 'g25', 'l25'];

/** Which demandlib generator a code belongs to: 'bdew25' | 'classic'. */
export function familyForSlp(code) {
  return BDEW25_CODES.includes(code) ? 'bdew25' : 'classic';
}
...
export const SLP_TO_SYNTHETIC = {
  ...
  h25: 'residential', g25: 'commercial', l25: 'mixed',
};
